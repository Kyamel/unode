...
// and exposes `mount()` + `dispatch()` to the React layer.
//
...
import { HostCallHandler, PluginInstance } from "./pluginHost";
import { OnAction } from "./renderer";
...
export class WebRuntime {
  ...
  /** Run load + render + mount, returning the store the React tree renders. */
  mount(): ScreenStore {
